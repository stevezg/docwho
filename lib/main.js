...
/***/ function(module, exports, __webpack_require__) {
	...
	var Search = React.createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    this.serverRequest = $.get('http://docwho-api-dev.us-west-1.elasticbeanstalk.com/doctors?speciality_id=' + params.speciality_id, function (result) {
	      console.log(result);
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(FilterBar, { offset: this.state.offset, results: this.state.results, totalCount: this.state.totalCount }),
	      React.createElement(
	        'div',
	        { className: 'grid' },
	        React.createElement(GoogleMap, { latitude: this.state.latitude, longitude: this.state.longitude }),
	...
	var FilterBar = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'form',
	        { action: '/search', method: 'get', enctype: 'multipart/form-data' },
	        React.createElement(
	          'div',
	          { className: 'text-field-container' },
	          React.createElement(Button, { className: 'themed-button-filter',
	            text: 'Insurance' }),
	          React.createElement(Button, { className: 'themed-button-filter',
	            text: 'Rating' }),
	          React.createElement(Button, { className: 'themed-button-filter',
