	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        'div',
	        { className: 'row' },
	        React.createElement(GoogleMap, { mlat: '55.0000', mlong: '-113.0000' }),
	        React.createElement(ResultsGrid, { doctors: this.state.doctors })
	      )
	    );
	  }
	});
...
/***/ function(module, exports) {
	...
	var GoogleMap = React.createClass({
	  ...
	  statics: {
	    showMarker: function showMarker(practiceLocation) {
	      console.log(this);
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      this.props.doctors.map(function (doctor) {
	        return React.createElement(ResultsTile, { doctor: doctor });
	      })
	    );
	  }
	});
	...
	var ResultsTile = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return(
	      ...
	      React.createElement(
	        'div',
	        { onClick: this.handleClick, className: 'profile-card', style: cardStyle },
	        React.createElement(
	          'div',
	        ...
	        React.createElement(
	          ...
	          React.createElement('i', { className: 'fa fa-star', style: { marginTop: '20px', color: '#FF4646' }, 'aria-hidden': 'true' }),
	          React.createElement('i', { className: 'fa fa-star', style: { marginTop: '20px', color: '#FF4646' }, 'aria-hidden': 'true' }),
	          React.createElement('i', { className: 'fa fa-star', style: { marginTop: '20px', color: '#FF4646' }, 'aria-hidden': 'true' }),
	          React.createElement('i', { className: 'fa fa-star', style: { marginTop: '20px', color: '#FF4646' }, 'aria-hidden': 'true' }),
	          React.createElement('i', { className: 'fa fa-star', style: { marginTop: '20px', color: '#FF4646' }, 'aria-hidden': 'true' })
